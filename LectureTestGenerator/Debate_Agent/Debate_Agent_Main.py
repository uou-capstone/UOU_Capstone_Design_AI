...
phase1_path = os.path.join(current_dir, 'phase1')
phase2_path = os.path.join(current_dir, 'phase2')
phase3_path = os.path.join(current_dir, 'phase3')
