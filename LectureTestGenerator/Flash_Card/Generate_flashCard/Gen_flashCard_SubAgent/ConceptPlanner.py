...
def Agent_ConceptPlanner(source_text, profile, target_count):
    ...
    # Flash_Card/Generate_flashCard/Gen_flashCard_SubAgent/ConceptPlanner.py -> 4단계 위가 루트
    ...
    ConceptPlanner_contents = [
        ...
        "Target Content Count: " + str(target_count)
    ]
