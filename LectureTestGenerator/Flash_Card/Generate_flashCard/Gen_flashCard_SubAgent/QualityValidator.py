...
def Agent_QualityValidator(target_content, source, guideline, required_count):
    # 환경 변수 불러오기
    ...
    # Flash_Card/Generate_flashCard/Gen_flashCard_SubAgent/QualityValidator.py -> 4단계 위가 루트
