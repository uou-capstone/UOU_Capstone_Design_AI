...
def Agent_CardWriter(source_text, plan, feedback, prior_content, num_cards, profile):
    # 환경 변수 불러오기
    ...
    cardWriter_contents = [
        lecture_content,
        "Concept Plan: " + json.dumps(plan),
        "Current Feedback: " + str(feedback),
        "Target Card Count: " + str(num_cards),
