...
def llm_evaluator_assess_closing(final_user_speech, history, lecture_material, difficulty, dialogue_style):
    ...
    eval_assess_closing_object_schema_pwd = "/Users/jhkim/Desktop/Debate_Agent/phase2/phase2_subAgent/phase2_subAgent_Prompt/eval_assess_closing/eval_assess_closing_Object.json"
    eval_assess_closing_system_prompt_pwd = "/Users/jhkim/Desktop/Debate_Agent/phase2/phase2_subAgent/phase2_subAgent_Prompt/eval_assess_closing/eval_assess_closing_SystemPrompt.md"

    with open(eval_assess_closing_object_schema_pwd, 'r', encoding='utf-8') as f:
        eval_assess_closing_object_schema = json.load(f)

    with open(eval_assess_closing_system_prompt_pwd, 'r', encoding='utf-8') as f:
